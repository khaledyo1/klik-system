...
function exportData(period) {
  ...
  const headers = ['نوع الحركة', 'التاريخ', 'الخدمة', 'العميل', 'الهاتف', 'المورد', 'عملة الشراء', 'حالة الحساب', 'الإيراد', 'تكلفة الشراء', 'تعويض فوري', 'تعويض من الطوارئ', 'الربح الحقيقي', 'رأس مال إضافي', 'رصيد/أثر الطوارئ', 'صافي أرباح 70%', 'المسؤول', 'تاريخ الانتهاء'];
